...
const Drinks = () => {
  return (
    <Box sx={{ width: "100%", height: "20rem" }}>
      ...
      <Box>
        <Typography variant="h4" style={{ fontWeight: 900 ,color:"#fff"}}>
          THỨC UỐNG
        </Typography>
        <Typography variant="subtitle1" style={{ fontWeight: 900 }}>
          Circle K luôn "thỏa cơn khát" của bạn 24/7 với đa dạng các loại thức
          uống từ nóng đến lạnh. Đặc biệt, bạn có thể cùng bạn bè thỏa sức sáng
          tạo thức uống của mình bằng cách tự pha trộn và kết hợp các hương vị
          có sẵn. Circle K luôn có thức uống mới để bạn thưởng thức và trải
          nghiệm.
        </Typography>
      </Box>
    </Box>
